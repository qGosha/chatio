...
const MessagesList = ({ dashboard, openDialog }) => {
  ...
  const sortedMessagesKeys = Object.keys(allMessages).filter( i => allMessages[i]).sort( (a, b) =>  {
  ...
  return <Fragment>
    ...
    <ModalWindow
      ...
      contenttext={"Are you sure you want to delete dialog with this user? This can't be undone."}
